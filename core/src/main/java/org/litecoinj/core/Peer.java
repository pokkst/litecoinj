 ...
 * {@link org.litecoinj.net.TimeoutHandler} and timeout is automatically disabled (using
 * {@link org.litecoinj.net.TimeoutHandler#setTimeoutEnabled(boolean)}) once the version
