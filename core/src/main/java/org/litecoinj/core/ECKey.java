...
public class ECKey implements EncryptableItem {
    ...
    public static class ECDSASignature {
         ...
         * href="https://github.com/litecoin/bips/blob/master/bip-0062.mediawiki#Low_S_values_in_signatures">BIP62</a>.
         */
     ...
     * determine if the signature was correct. These sorts of signatures are compatible with the Bitcoin-Qt/litecoind
     ...
     * litecoins controlled by the private key) you can use this method to check when you *encrypt* a wallet that
