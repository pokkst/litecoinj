 ...
 * {@link org.litecoinj.core.NetworkParameters} provided that those references are in <b>deprecated</b> methods. This will
 * smooth migration by allowing users to, for example, replace {@code import org.litecoinj.base.Address} with
 * {@code import org.litecoinj.core.Address} as first step of conversion and remove usages of the deprecated methods in
 * a second step.
 * <p>
