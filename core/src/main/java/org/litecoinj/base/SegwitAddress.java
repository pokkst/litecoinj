 ...
 * {@link #fromHash(org.litecoinj.base.Network, byte[])} or {@link ECKey#toAddress(ScriptType, Network)}
...
public class SegwitAddress implements Address {
     ...
     * @return constructed address
     * @deprecated Use {@link ECKey#toAddress(ScriptType, org.litecoinj.base.Network)}
     */
    @Deprecated
